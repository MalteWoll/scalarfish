...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    protected void deliverAndDrawFrame(CvCameraViewFrame frame) {
        ...
        /* Replaced with code from https://gist.github.com/heaversm/63e8036af6a124aecf3b26898bd2a0ad#file-opencv-portait-camera-android-java to fix the camera view
        Mat modified;
